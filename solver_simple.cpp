...
static const double alpha = 0.2; // feed rate of activator
static const double beta  = 2.0; // feed rate of inhibitor
...
void diffuseGaussSeidel(std::vector<double> &X, const std::vector<double> &RHS,
                        double diffCoeff)
{
    // We solve (X - dt*diffCoeff*Lap(X)) = RHS (RHS is temporary field after reaction step.)
